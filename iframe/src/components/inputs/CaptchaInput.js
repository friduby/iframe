    ...
    renderInput() {
        return (
            <div className="">
                ...
                <a onClick={this.refreshCaptcha.bind(this)}><img id="" src="https://ebank.bdi24.com/webbank/images/loginWithAd/refresh.png" alt="تغییر عکس" title="تغییر عکس" style={{marginBottom:'50px'}}/></a>
            </div>
        );
    }
}
