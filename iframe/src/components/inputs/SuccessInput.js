        ...
        return (
            <div className="iframe-success">
                ...
                <div className="">
                    ...
                    <p style={{ fontSize:'17px', marginTop:'4px', marginBottom:'4px'}}> <span style={{marginRight:'10px'}}>{this.props.transaction_id}</span>:کد پیگیری</p>  
                    <p style={{ fontSize:'17px', marginTop:'4px', marginBottom:'4px'}}> <span style={{marginRight:'10px'}}>{this.props.transaction_date}</span>:تاریخ</p>  
