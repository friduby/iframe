    ...
    renderInput() {
        return (
            <div style={{display:'block'}}>
                ...
                <br />
                <input disabled={this.props.disabled} className="form-control uk-input-medium uk-margin-small-top uk-width-3-4" style={{height:'30px', display:'inline', textAlign:'center'}} placeholder={this.props.placeholder} type="text" value={this.props.defaultVal || this.state.value} onChange={this.onValueChange.bind(this)} maxLength={this.props.maxLength}></input>
            </div>
        );
    }
}
